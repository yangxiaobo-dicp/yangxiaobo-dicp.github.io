(function () {
  ...
  var I18N = {
    zh: {
      ...
      'nav.awards': '荣誉奖项',
      'nav.contact': '联系',
      'hero.role': '博士后 · 电催化与能源材料',
      'hero.affil': '中国科学院大连化学物理研究所',
      ...
      'news.n1': '论文“Secondary Coordination Sphere Engineering of Single-Sn-Atom Catalyst”发表于 Advanced Energy Materials（共同一作）。',
      'news.n2': '综述“Single-atom catalysis: a promising avenue for precisely controlling reaction pathways”发表于 Frontiers of Chemical Science and Engineering（第一作者）。',
      'news.n3': '获评大连化学物理研究所“优秀博士后（C类）”（2022–2024）。',
      'news.n4': '论文“Size effect of ruthenium nanoparticles on water cracking”发表于 Journal of Colloid and Interface Science（共同一作）。',
      'news.n5': '加入中国科学院大连化学物理研究所，开展博士后研究。',
      'news.n6': '两篇第一作者论文发表于 Advanced Energy Materials。',
      'edu.title': '教育经历',
      'edu.subtitle': '本科、硕博与博士后研究经历',
      ...
      'contact.office.desc': '辽宁省大连市 · 中国科学院大连化学物理研究所',
    ...
    en: {
      ...
      'nav.awards': 'Awards',
      'nav.contact': 'Contact',
      'hero.role': 'Postdoctoral Researcher · Electrocatalysis & Energy Materials',
      'hero.affil': 'Dalian Institute of Chemical Physics, Chinese Academy of Sciences',
      ...
      'news.n1': 'Paper “Secondary Coordination Sphere Engineering of Single-Sn-Atom Catalyst” published in Advanced Energy Materials (co-first author).',
      'news.n2': 'Review “Single-atom catalysis: a promising avenue for precisely controlling reaction pathways” published in Frontiers of Chemical Science and Engineering (first author).',
      'news.n3': 'Awarded “Outstanding Postdoctoral Fellow (Class C)” by Dalian Institute of Chemical Physics (2022–2024).',
      'news.n4': 'Paper “Size effect of ruthenium nanoparticles on water cracking” published in Journal of Colloid and Interface Science (co-first author).',
      'news.n5': 'Joined Dalian Institute of Chemical Physics, CAS, as a postdoctoral researcher.',
      'news.n6': 'Two first-authored papers published in Advanced Energy Materials.',
      'edu.title': 'Education',
      'edu.subtitle': 'BSc, MSc, PhD and postdoctoral training',
      ...
      'contact.office.desc': 'Dalian, Liaoning · Dalian Institute of Chemical Physics, CAS',
