(function () {
  ...
  var I18N = {
    zh: {
      ...
      'nav.awards': '荣誉奖项',
      'nav.contact': '联系',
      'hero.role': '助理研究员 · 含能材料与绿色硝化',
      'hero.affil': '中国科学院大连化学物理研究所 · 30室',
      'hero.bio': '研究方向聚焦于含能材料、绿色硝化与单原子催化剂，重点关注高能化合物的设计合成、绿色硝化新工艺开发，以及单原子催化剂对反应路径的精准调控。以第一作者或共同第一作者在 JACS、Advanced Energy Materials、Small 等期刊发表论文 12 篇。',
      'hero.cta1': '查看发表论文',
      'hero.cta2': '联系我',
      'news.title': '新闻动态',
      ...
      'research.r1.title': '含能材料',
      'research.r1.desc': '高能化合物的设计、合成与性能调控研究。',
      'research.r2.title': '绿色硝化',
      'research.r2.desc': '绿色硝化工艺开发，探索安全、高效的硝化反应新路线。',
      'research.r3.title': '单原子催化剂',
      'research.r3.desc': '单/多原子催化剂的可控合成，及其对反应路径的精准调控。',
      'pubs.title': '发表论文',
      'pubs.subtitle': '以第一作者或共同第一作者发表的代表性成果（12 篇）',
      'pubs.all': '全部',
      'pubs.first': '第一作者',
      'pubs.cofirst': '共同一作',
      'badge.first': '第一作者',
    ...
    en: {
      ...
      'nav.awards': 'Awards',
      'nav.contact': 'Contact',
      'hero.role': 'Assistant Researcher · Energetic Materials & Green Nitration',
      'hero.affil': 'Dalian Institute of Chemical Physics (DICP), Chinese Academy of Sciences · Division 30',
      'hero.bio': 'My research focuses on energetic materials, green nitration and single-atom catalysis, with emphasis on the design and synthesis of high-energy compounds, the development of green nitration processes, and the precise regulation of reaction pathways by single-atom catalysts. I have published 12 papers as first or co-first author in journals including JACS, Advanced Energy Materials and Small.',
      ...
      'edu.w1.role': 'Assistant Researcher · Energetic Materials & Green Nitration',
      ...
      'research.r1.title': 'Energetic Materials',
      'research.r1.desc': 'Design, synthesis and performance tuning of high-energy compounds.',
      'research.r2.title': 'Green Nitration',
      'research.r2.desc': 'Development of green nitration processes toward safe and efficient synthetic routes.',
      'research.r3.title': 'Single-Atom Catalysis',
      'research.r3.desc': 'Controllable synthesis of single-/multi-atom catalysts and precise regulation of reaction pathways.',
      'pubs.title': 'Publications',
      'pubs.subtitle': 'Selected publications as first or co-first author (12 papers)',
      'pubs.all': 'All',
