(function () {
  ...
  var I18N = {
    zh: {
      ...
      'hero.bio': '研究方向聚焦于电催化与含能材料，重点关注单原子催化剂设计与电化学 CO₂/硝酸根还原制尿素等小分子转化过程，同时开展含能材料与绿色硝化新工艺的研究。以第一作者或共同第一作者在 JACS、Advanced Energy Materials、Small 等期刊发表论文 12 篇。',
      'hero.cta1': '查看发表论文',
      'hero.cta2': '联系我',
      'news.title': '新闻动态',
    ...
    en: {
      ...
      'hero.bio': 'My research focuses on electrocatalysis and energetic materials, with emphasis on single-atom catalyst design and electrochemical conversion of small molecules such as CO₂ and nitrate (including co-reduction to urea), as well as energetic materials and green nitration processes. I have published 12 papers as first or co-first author in journals including JACS, Advanced Energy Materials and Small.',
